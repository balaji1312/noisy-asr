...
zsh run_214A_3.sh 0 1 1 1

cd data

ex train_spc/wav.scp <<EOEX
  :g/databases/t.|s#.wav#_1.txt# |s#nohash_\(.\{-}\)-#nohavh_\1_1-#
  :%s#databases/spc#databases/pink/spc#
  :%s#.wav#_2.txt#
  :%s#nohash_\(.\{-}\)-#nohash_\1_2-#
  :%s#nohavh_\(.\{-}\)-#nohash_\1-#
  :wq
EOEX
...
for part in test_spc test_spc_5dB dev_spc dev_spc_5dB train_spc train_spc_5dB; do
...
zsh run_214A_3.sh 0 2 3 1

zsh run_214A_3.sh 1 2 3 0

zsh run_214A_3.sh 0 4 5 1

zsh run_214A_3.sh 1 4 5 0